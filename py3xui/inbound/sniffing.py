...
1. **Docstring Consistency**: Simplified the description of the `Sniffing` class to be more concise and focused on the main purpose.
2. **Attribute Descriptions**: Updated the wording of the `dest_override` attribute to use "The" and ensured "Whether to" is used for the other optional attributes for consistency.
